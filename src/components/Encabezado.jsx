          ...
          {/* <div className="container grid grid-cols-3 h-34 items-center aling-center */}
           ...
           <div className="container grid grid-rows-3 grid-flow-col gap-4 h-34 items-center aling-center font-bold text-2xl bg-blue-400 hover:bg-blue-200  border-2 rounded  border-blue-500 p-1">
             ...
             <div className="row-span-3 col-span-1  ">
                <button className="bg-blue-600 rounded-full mx-auto border border-purple-200 hover:border-transparent focus:outline-none text-lg p-1 " width="50" height="50" onClick={()=>inicio(false)} >INICIO </button>
             </div>
             </div>
